    ...
    <section className="relative min-h-screen flex items-center justify-center bg-grid overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center pt-24">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <a
            href="#contact"
            className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-cyan-500 rounded-full text-white font-semibold text-lg hover:shadow-2xl hover:shadow-indigo-500/30 transition-all hover:scale-105"
          >
            Start Free Trial
          </a>
          <a
            href="#features"
            className="px-8 py-4 bg-white/5 border border-white/10 rounded-full text-white font-semibold text-lg hover:bg-white/10 transition-all"
          >
            Explore Features →
          </a>
        </div>
